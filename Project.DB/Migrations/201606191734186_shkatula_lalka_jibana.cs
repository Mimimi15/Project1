namespace Project.DB.Migrations
{
    ...
    public partial class shkatula_lalka_jibana : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Record", "MasterId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Record", "ClientId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropIndex("dbo.AspNetUserRoles", new[] { "UserId" });
            DropIndex("dbo.AspNetUserRoles", new[] { "RoleId" });
            DropIndex("dbo.Record", new[] { "MasterId" });
            DropIndex("dbo.Record", new[] { "ClientId" });
